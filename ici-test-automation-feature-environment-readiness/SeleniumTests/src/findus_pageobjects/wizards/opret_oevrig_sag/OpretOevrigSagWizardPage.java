package findus_pageobjects.wizards.opret_oevrig_sag;
...
public class OpretOevrigSagWizardPage extends BaseWizardPage {

    public OpretOevrigSagWizardPage() {
        super("Opret øvrig sag");
    }
