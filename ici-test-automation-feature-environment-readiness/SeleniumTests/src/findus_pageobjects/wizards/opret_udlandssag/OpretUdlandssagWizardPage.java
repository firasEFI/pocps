package findus_pageobjects.wizards.opret_udlandssag;
...
public class OpretUdlandssagWizardPage extends BaseWizardPage {

    public OpretUdlandssagWizardPage() {
        super("Opret udlandssag");
    }
