package findus_pageobjects.wizards.opret_klagesag;
...
public class OpretKlagesagWizardPage extends BaseWizardPage {

    public OpretKlagesagWizardPage() {
        super("Opret klagesag");
    }
