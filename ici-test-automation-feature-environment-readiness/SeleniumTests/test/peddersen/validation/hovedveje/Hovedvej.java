...
public abstract class Hovedvej extends TestContext {
    ...
    private void printDone(ITestResult result) {
        System.out.printf("Hovedvej %s er %s.%n", getName(), status(result));
    ...
    private void printInitiated() {
        System.out.printf("Påbegynder Hovedvej %s.%n", getName());
    }
