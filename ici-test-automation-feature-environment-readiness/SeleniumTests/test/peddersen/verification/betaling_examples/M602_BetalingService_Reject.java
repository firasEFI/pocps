...
public class M602_BetalingService_Reject extends TestContext {
    ...
    public void test() throws ParseException, IOException {
        ...
        // Variables
        double paymentAmount = 111;
        String ocrLine = "306525030767674";
        BetalingsfilType indbetalingsType = BetalingsfilType.M602_REJECTED_BETALINGSSERVICE;
        BetalingsfilType finstaType = BetalingsfilType.FINSTA_NETS;

        // Indbetalinger
        // M602 Rejected betalingsservice
