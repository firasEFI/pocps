...
class RoutingTest {
	...
	private static final String JOB_DESCRIPTION_ROUTING = "Routing"
	...
	/* Variable for test */
	private static final BatchStatus BATCH_STATUS1 = BatchStatus.KLAR_TIL_ROUTING
	private static final BatchStatus BATCH_STATUS2 = BatchStatus.KLAR_TIL_ROUTING
	...
	void testBatchReturnCode() {
	    ...
	    //TEST Routing
		def jobReturnCode = BatchController.runNyMFJob(JOB_DESCRIPTION_ROUTING)
