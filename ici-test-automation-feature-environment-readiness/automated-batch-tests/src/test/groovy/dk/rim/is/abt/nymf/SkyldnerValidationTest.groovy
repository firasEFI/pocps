 ...
 */
class SkyldnerValidationTest {

    private static final String JOB_DESCRIPTION_SKYLDNER_VALIDATION = "SkylderValidation"
    ...
    /* Variable for test */
    private static final BatchStatus BATCH_STATUS1 = BatchStatus.KLAR_TIL_ASYNC_FLOW
    private static final BatchStatus BATCH_STATUS2 = BatchStatus.KLAR_TIL_ASYNC_FLOW
    ...
    void testBatchReturnCode() {
        ...
        //TEST SkylderValidation
        def jobReturnCode = BatchController.runNyMFJob(JOB_DESCRIPTION_SKYLDNER_VALIDATION)
        ...
        assert aktionState.getBatchStatus().equals(BatchStatus.KLAR_TIL_VALIDERING)
