...
@Entity
@Table(name = "KVITTERING_HENT_HISTORIK",
        uniqueConstraints = {@UniqueConstraint(name="UK_KH_TRANSAKTION_HISTORIK_ID", columnNames = {"TRANSAKTION_HISTORIK_ID"})
        })
public class KvitteringHentHistorik implements IHistorikEntity {
    ...
    @JoinColumn(name="TRANSAKTION_HISTORIK_ID", unique=true, nullable=false, updatable=false, foreignKey = @ForeignKey(name = "KVITTERING_HENT_HISTORIK"))
