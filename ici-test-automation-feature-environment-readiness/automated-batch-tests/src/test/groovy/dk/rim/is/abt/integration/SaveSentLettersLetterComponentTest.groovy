...
import dk.rim.is.abt.dao.cisadm.*
 ...
 */
class SaveSentLettersLetterComponentTest {
    ...
    private String brevIdCcId = "7523413680"

    private String brevIdPerId = "7523413594"

    private String brevIdDate = "20170713"
    ...
    void setupDb() {
        ...
        ciCcEntity.setCcTypeCd("IND_BLANK")
    ...
    void clearDb() {
        ...
        genereretBrevPdfDao.delete({entity -> genereretBrevPdf.getId().equals(entity.getId())} as Predicate)
        genereretBrevDao.delete({entity -> genereretBrev.getId().equals(entity.getId())} as Predicate)
