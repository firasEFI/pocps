 ...
 * @since 26.01.2017
 */
public class SpringContextNymf {
    private static ClassPathXmlApplicationContext context = new ClassPathXmlApplicationContext("classpath:META-INF/application-contextNyMF.xml");
