 ...
 */
class RetskraftsvurderingTest {

	private static final String JOB_DESCRIPTION_RETSKRAFTSVURDERING = "Retskraftsvurdering"
	...
	/* Variable for test */
	private static final BatchStatus BATCH_STATUS1 = BatchStatus.KLAR_TIL_VALIDERING
	private static final BatchStatus BATCH_STATUS2 = BatchStatus.KLAR_TIL_VALIDERING
	...
	void testBatchReturnCode() {
        ...
        def jobReturnCode = BatchController.runNyMFJob(JOB_DESCRIPTION_RETSKRAFTSVURDERING)
        ...
        assert aktionState.getBatchStatus().equals(BatchStatus.KLAR_TIL_ROUTING)
        ...
        assert aktionState.getBatchStatus().equals(BatchStatus.KLAR_TIL_ROUTING)
        assert aktionState.getHoeringFlag().equals(true)
        assert aktionState.getStatus().equals(MFAktionStatusKodeType.MODTAGET)
