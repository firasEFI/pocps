 ...
 */
class SendToHearingTest {

	private static final String JOB_DESCRIPTION_SEND_TO_HEARING = "SendToHearing"
	...
	/* Variable for test */
	private static final BatchStatus BATCH_STATUS1 = BatchStatus.KLAR_TIL_HOERING
	private static final BatchStatus BATCH_STATUS2 = BatchStatus.KLAR_TIL_HOERING

	private static final BatchTargetSystem BATCH_TARGET_SYSTEM1 = null
	private static final BatchTargetSystem BATCH_TARGET_SYSTEM2 = null

	private static final Boolean HOERING_FLAG1 = true
	private static final Boolean HOERING_FLAG2 = true

	private static final MFAktionStatusKodeType STATUS1 = MFAktionStatusKodeType.HOERING
	private static final MFAktionStatusKodeType STATUS2 = MFAktionStatusKodeType.HOERING
	...
	void testBatchReturnCode() {
		...
		def jobReturnCode = BatchController.runNyMFJob(JOB_DESCRIPTION_SEND_TO_HEARING)
		println String.format("Batch ID is %s and return status is %s", jobReturnCode.batchJobExecutionId, jobReturnCode.executionStatus)
		...
		assert aktionState.getBatchStatus().equals(BatchStatus.SENDT_TIL_HOERING)
