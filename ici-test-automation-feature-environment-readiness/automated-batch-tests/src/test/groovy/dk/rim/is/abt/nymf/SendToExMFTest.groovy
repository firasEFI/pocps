 ...
 */
class SendToExMFTest {

	private static final String JOB_DESCRIPTION_SEND_TO_EXMF = "SendToExMF"
	...
	/* Variable for test */
	private static final BatchStatus BATCH_STATUS1 = BatchStatus.SENDT
	...
	void testBatchReturnCode() {
		...
		def jobReturnCode = BatchController.runNyMFJob(JOB_DESCRIPTION_SEND_TO_EXMF)
