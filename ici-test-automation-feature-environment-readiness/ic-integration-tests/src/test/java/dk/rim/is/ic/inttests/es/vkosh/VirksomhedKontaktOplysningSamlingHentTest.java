package dk.rim.is.ic.inttests.es.vkosh;
...
public class VirksomhedKontaktOplysningSamlingHentTest {
    private static final Logger LOG = LoggerFactory.getLogger(VirksomhedKontaktOplysningSamlingHentTest.class);

    private static final String SAMPLES_PATH = "es/vkosh/";
    ...
    public static void loadProperties() {
        ...
        String esServicePath = Property.IC_ES_VKOSH_PATH.load();
    ...
    @Test
    public void VirksomhedKontaktOplysningSamling_validRequest_expects200code() throws Exception {
