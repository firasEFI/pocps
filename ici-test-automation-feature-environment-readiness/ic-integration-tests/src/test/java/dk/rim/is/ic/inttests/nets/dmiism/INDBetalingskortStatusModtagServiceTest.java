 ...
 */
public class INDBetalingskortStatusModtagServiceTest {

    private static final Logger LOG = LoggerFactory.getLogger(INDBetalingskortStatusModtagServiceTest.class);
    ...
    public static void loadProperties() {
        ...
        String path = Property.IC_NETS_INDISM_PATH.load();
    ...
    public void styretfilover_modtagAnmod_valid_message_expect200code() throws Exception {
        ...
        given().log().all()
                ...
                .body(containsString("INDIndbetalingskortStatusModtagService"));
    }

    @Test
    public void when_modtagAfslut_is_called_is_not_supported() throws Exception {
