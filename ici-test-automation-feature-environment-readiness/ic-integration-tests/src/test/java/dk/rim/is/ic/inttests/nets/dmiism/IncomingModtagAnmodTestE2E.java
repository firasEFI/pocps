...
import static dk.rim.is.common.entity.managedfiletransfer.enums.IntegrationFileTypeName.NETS_686;
...
public class IncomingModtagAnmodTestE2E extends NetsTestBase {
    ...
    public void incoming_modtaganmod() throws Exception {
        ...
        //when
        simulateFtpgwModtagAnmodCall("INDIndbetalingskortStatusModtagService");
    ...
    private void createFileAndStoreFileOnFtp() throws IOException {
        fileInfo = netsUtil.insertTestIntegrationFile(IOUtils.toString(new FileInputStream(new File(SAMPLE_DATA)), "UTF-8"), NETS_686);

        uploadFileToFtp(fileInfo, CommonURLs.NETS_ENDPOINT.INDISM);
    }
