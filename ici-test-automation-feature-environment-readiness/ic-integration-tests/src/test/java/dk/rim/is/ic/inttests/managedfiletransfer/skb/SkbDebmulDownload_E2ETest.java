 ...
 * @since 06.02.2017
 */
public class SkbDebmulDownload_E2ETest extends FileDownloadReadyE2ETestBase {
    ...
    protected String icRequestPath() {
        return Property.IC_SKB_INDUOLM_PATH.load();
    }

    @Override
    protected IntegrationFileTypeName testedFileType() {
        return IntegrationFileTypeName.SKB_DEBMUL;
    }
}
